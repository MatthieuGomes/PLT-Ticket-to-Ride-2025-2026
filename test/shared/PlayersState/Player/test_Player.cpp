...
BOOST_AUTO_TEST_CASE(Constructor)
{
    ...
    std::vector<std::shared_ptr<cardsState::DestinationCard>> destCards = {std::make_shared<cardsState::DestinationCard>(dest)};
    std::vector<std::shared_ptr<cardsState::WagonCard>> wagonCardsVec = {std::make_shared<cardsState::WagonCard>(wagon)};

    std::shared_ptr<cardsState::PlayerCards> hand = std::make_shared<cardsState::PlayerCards>(destCards, wagonCardsVec);

    Player player(1, "yosra", cardsState::ColorCard::RED, 23, 21, 10, 5, hand.get());
    ...
    BOOST_CHECK_EQUAL(player.hand, hand.get());
...
BOOST_AUTO_TEST_CASE(getHand)
{

    {
        ...
        std::shared_ptr<cardsState::PlayerCards> hand = std::make_shared<cardsState::PlayerCards>(destCards, wagonCardsVec);
        Player player(1, "yosra", cardsState::ColorCard::RED, 23, 21, 10, 5, hand.get());
        BOOST_CHECK_EQUAL(player.getHand(), hand.get());
...
BOOST_AUTO_TEST_CASE(setScore)
{

    {
        ...
        std::vector<std::shared_ptr<cardsState::WagonCard>> wagonCardsVec = {std::make_shared<cardsState::WagonCard>(wagon)};
        std::shared_ptr<cardsState::PlayerCards> hand = std::make_shared<cardsState::PlayerCards>(destCards, wagonCardsVec);
        Player player = Player(1, "yosra", cardsState::ColorCard::RED, 23, 21, 10, 5, hand.get());
        player.setScore(40);
...
BOOST_AUTO_TEST_CASE(setHand)
{

    {
        ...
        std::vector<std::shared_ptr<cardsState::DestinationCard>> destCards1 = {std::make_shared<cardsState::DestinationCard>(dest1)};
        std::vector<std::shared_ptr<cardsState::WagonCard>> wagonCardsVec1 = {std::make_shared<cardsState::WagonCard>(wagon1)};
        std::shared_ptr<cardsState::PlayerCards> hand1 = std::make_shared<cardsState::PlayerCards>(destCards1, wagonCardsVec1);

        Player player(1, "yosra", cardsState::ColorCard::RED, 23, 21, 10, 5, hand.get());
        player.setHand(hand1.get());
        BOOST_CHECK_EQUAL(player.hand, hand1.get());
