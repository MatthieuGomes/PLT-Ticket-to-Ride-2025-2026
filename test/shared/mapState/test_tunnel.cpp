...
BOOST_AUTO_TEST_CASE(TestConstructor)
{
  ...
  Tunnel tunnel = Tunnel(&mapState, testId, testOwner, &testStation1, &testStation2, testColor, testLength, testBlocked);
  BOOST_CHECK(tunnel.id == testId);
  BOOST_CHECK(tunnel.isBlocked == testBlocked);
  BOOST_CHECK(tunnel.owner == testOwner);
  BOOST_CHECK(tunnel.color == testColor);
  BOOST_CHECK(tunnel.length == testLength);
  BOOST_CHECK(tunnel.stationA == &testStation1);
  BOOST_CHECK(tunnel.stationB == &testStation2);
}
...
BOOST_AUTO_TEST_CASE(TestGetId)
{
  ...
  Tunnel tunnel = Tunnel(&mapState, testId, testOwner, &testStation1, &testStation2, testColor, testLength, testBlocked);
  BOOST_CHECK(tunnel.getId() == testId);
}
...
BOOST_AUTO_TEST_CASE(TestGetOwner)
{
  ...
  Tunnel tunnel = Tunnel(&mapState, testId, testOwner, &testStation1, &testStation2, testColor, testLength, testBlocked);
  BOOST_CHECK(tunnel.getOwner() == testOwner);
}
...
BOOST_AUTO_TEST_CASE(TestGetBlockStatus)
{
  ...
  Tunnel tunnel = Tunnel(&mapState, testId, testOwner, &testStation1, &testStation2, testColor, testLength, testBlocked);
  BOOST_CHECK(tunnel.getBlockStatus() == testBlocked);
}
...
BOOST_AUTO_TEST_CASE(TestGetStationA)
{
  ...
  Tunnel tunnel = Tunnel(&mapState, testId, testOwner, &testStation1, &testStation2, testColor, testLength, testBlocked);
  BOOST_CHECK(tunnel.getStationA() == &testStation1);
}
...
BOOST_AUTO_TEST_CASE(TestGetStationB)
{
  ...
  Tunnel tunnel = Tunnel(&mapState, testId, testOwner, &testStation1, &testStation2, testColor, testLength, testBlocked);
  BOOST_CHECK(tunnel.getStationB() == &testStation2);
}
