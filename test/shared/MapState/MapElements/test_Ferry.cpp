...
BOOST_AUTO_TEST_CASE(Default)
{
  ...
  mapState::Ferry test_ferry = mapState::Ferry(test_ferry_id, test_owner, test_stationA, test_stationB, test_color, test_length, test_locomotives, test_edge);
...
BOOST_AUTO_TEST_CASE(BatchConstructor)
{
  ...
  std::vector<FerryInfo> ferryInfos = {
      Ferry::genData(batch_stationA, batch_stationB, 201, batch_owner1, cardsState::ColorCard::PINK, 3, 1),
      Ferry::genData(batch_stationB, batch_stationC, 202, batch_owner2, cardsState::ColorCard::ORANGE, 4, 2),
      Ferry::genData(batch_stationA, batch_stationC, 203, batch_owner3, cardsState::ColorCard::BLUE, 5, 3),
  };
...
{
  std::vector<FerryInfo> ferryInfos = {
      Ferry::genData(test_stationA, test_stationB, 501, test_owner, cardsState::ColorCard::GREEN, test_length, test_locomotives)};
...
BOOST_AUTO_TEST_CASE(GenData)
{
  ...
  FerryInfo info = Ferry::genData(test_stationA, test_stationB, test_ferry_id, test_owner, test_color, test_length, test_locomotives);
...
mapState::Ferry test_ferry_getters_and_setters = mapState::Ferry(test_ferry_id, test_owner, test_stationA, test_stationB, test_color, test_length, test_locomotives, test_edge);
