...
void state::DeckInvisible::addCard(std::shared_ptr<Card> card) {
    cards.push_back(card);
}

std::shared_ptr<Card> state::DeckInvisible::removeCard() {
...
void state::DeckInvisible::shuffle(uint16_t a1, uint16_t c1, uint16_t x01,
