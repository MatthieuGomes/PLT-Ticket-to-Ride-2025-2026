...
namespace mapState
{
    ...
    MapState MapState::Test()
    {
        ...
        std::vector<RoadInfo> roadsInfos = {
            Road::genDataByName(stationsObject, "A", "B", 1, roadOwnerAB_1, cardsState::ColorCard::RED, 3),
            Road::initDataByName(stationsObject, "A", "B", 2, cardsState::ColorCard::BLUE, 3),
            Road::genDataByName(stationsObject, "B", "C", 3, roadOwnerBC_1_n_FI, cardsState::ColorCard::YELLOW, 2),
            Road::initDataByName(stationsObject, "B", "C", 4, cardsState::ColorCard::GREEN, 2),
            Road::initDataByName(stationsObject, "B", "D", 5, cardsState::ColorCard::BLACK, 4),
            Road::initDataByName(stationsObject, "B", "D", 6, cardsState::ColorCard::WHITE, 4),
            Road::initDataByName(stationsObject, "B", "E", 7, cardsState::ColorCard::PINK, 4),
            Road::initDataByName(stationsObject, "B", "E", 8, cardsState::ColorCard::ORANGE, 4),
            Road::initDataByName(stationsObject, "B", "F", 9, cardsState::ColorCard::RED, 5),
            Road::genDataByName(stationsObject, "F", "G", 10, roadOwnerFG, cardsState::ColorCard::NONE, 2),
            Road::initDataByName(stationsObject, "F", "H", 11, cardsState::ColorCard::GREEN, 3),
            Road::genDataByName(stationsObject, "F", "I", 12, roadOwnerBC_1_n_FI, cardsState::ColorCard::RED, 4),
        };
